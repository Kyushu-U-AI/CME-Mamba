...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        if not os.path.exists(self.args.train_records):
            os.makedirs(self.args.train_records)
        else:
            pass
        ...
        for epoch in range(self.args.train_epochs):
            ...
            train_records = os.path.join(self.args.train_records, f"{setting}.txt")
            with open(train_records, 'a') as f:
    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                preds.append(pred)
                trues.append(true)
                # TODO When officially implement codes please: Cancel!
                # if i % 20 == 0:
